...
def calculate_mAP(det_boxes, det_labels, det_scores, true_boxes, true_labels, true_difficulties):
    ...
    for c in range(1, n_classes):
        ...
        for d in range(n_class_detections):
            ...
            object_diffic0ulties = true_class_difficulties[true_class_images == this_image]  # (n_class_objects_in_img)
...
def calculate_mAP_fork(det_boxes, det_labels, det_scores, true_boxes, true_labels, my_label_map=['frame', 'text', 'face', 'body']):
    ...
    for c in range(1, n_classes + 1):
        ...
        true_class_images = true_images[true_labels == c]  # (n_class_objects)
        true_class_boxes = true_boxes[true_labels == c]  # (n_class_objects, 4)
        # true positive total label size
        ...
        # cumul_recall = cumul_true_positives / n_easy_class_objects  # (n_class_detections)
        # n_easy_class_objects -> n_class_objects, do not know why divide by n_easy_class_objects.
